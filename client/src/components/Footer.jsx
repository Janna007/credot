    ...
    <div className='min-h-[350px]'>
      ...
      <div className='flex mt-[50px] gap-[100px]   '>
         ...
         <div className="w-[1px] h-[120px] opacity-40 bg-[#D9D9D9] mt-[-20px]">
          ...
          <div className='ml-[100px] space-y-[10px] '>
                  ...
                  <h1 className='font_poppins font-semibold text-[26px] leading-[20px] text-[#1B1B1B]'  style={{ letterSpacing: '0.35px' }} > 1800 456 84788</h1>
          </div>
         </div>
      </div>


     <div className='w-[1100px] h-[1px] bg-[#DCDCDC] mt-[50px] mx-auto'>
      {/* horizontal line */}
     </div>
